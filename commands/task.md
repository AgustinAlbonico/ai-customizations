...
Activa el skill "interactive-work" en modo TAREA y ayuda al usuario a completar su tarea.

El usuario te ha dado una descripción inicial de la tarea. Tu trabajo:

1. **Usar el skill interactive-work (modo TAREA)** para hacer preguntas adaptativas
...
5. **Identificar el subtipo** (nuevo, cambio, refactor, config, mejora)
6. **Adaptar las preguntas** según el subtipo identificado
7. **Definir alcance IN/OUT** explícito antes de ejecutar
8. **Investigar el codebase** para entender contexto y patrones existentes
9. **Ejecutar** siguiendo los patrones del proyecto, con la mínima complejidad necesaria
